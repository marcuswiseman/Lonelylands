...
// helpers
	...
	function dependArray(value) {
		for (var e = void0, i = 0, l = value.length; i < l; i++) {
			e = value[i];
	...
	function assertProp(
		...
		if (!valid) {
			warn(
				"Invalid prop: type check failed for prop \"" + name + "\"." + " Expected " + expectedTypes.map(capitalize).join(', ') + ", got " + toRawType(value) + ".",
				vm
			);
			return
		}
...
// contain child elements.
	...
	function updateClass(oldVnode, vnode) {
		...
		if (
			isUndef(data.staticClass) && isUndef(data.class) && (isUndef(oldData) || isUndef(oldData.staticClass) && isUndef(oldData.class))
		) {
			return
		}
	...
	function parseHTML(html, options) {
		...
		while (html) {
			...
			if (!lastTag || !isPlainTextElement(lastTag)) {
				...
				var text = void0, rest = void0, next = void0;
				if (textEnd >= 0) {
